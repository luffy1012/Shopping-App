...
class _CartTabState extends State<CartTab> {
  ...
  TextStyle _textStyle =
      TextStyle(fontWeight: FontWeight.w400, fontSize: 15, letterSpacing: 1.5);
  List products = [];
  Future _myFuture;
  double totalAmt = 0;
  @override
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          products.forEach((element) {
            totalAmt += element[CartDataProvider.colQty] *
                element[CartDataProvider.colPrice];
          });
          return isLoading
                            ...
                            children: [
                              ...
                              getButton("Proceed", Icons.arrow_forward_ios,
                                ...
                                if (products.length != 0) {
                                  ...
                                  await Provider.of<SharedPrefProvider>(context,
                                          listen: false)
                                      .isLoggedIn()
                                      .then((value) {
                                    setState(() {
                                    ...
                                    if (value) {
                                      Navigator.pushNamed(
                                          context, TimeSlotPage.routeName);
                                    } else {
                                      Navigator.pushNamed(
                                  ...
                                  showDialog(
                                    ...
                                    builder: (context) {
                                      return AlertDialog(
                                        ...
                                        content: Text(
                                            "Please add products into the cart before proceeding!"),
                                        actions: [
                                          getButton(
                                              "OK",
                    ...
                    Expanded(
                      child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            var prodQtyRes =
                                products[index][CartDataProvider.colQtyRes];
                                                          ...
                                                          content: Row(
                                                            children: [
                                                              ...
                                                              SizedBox(
                                                                  width: 10),
                                                              Text(
                                                                  "Maximum product quantity reached!")
                                                            ],
                                                          ),
                                                        );
  ...
  Future deleteProduct(String productID) async {
    var res = await Provider.of<CartDataProvider>(context, listen: false)
